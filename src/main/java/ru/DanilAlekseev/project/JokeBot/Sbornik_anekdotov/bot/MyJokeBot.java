package ru.DanilAlekseev.project.JokeBot.Sbornik_anekdotov.bot;
...
import ru.DanilAlekseev.project.JokeBot.repository.JokesRepository;
import ru.DanilAlekseev.project.JokeBot.service.UsersService;
...
@Service
public class
MyJokeBot extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update) {
        if (update.hasMessage() && update.getMessage().hasText()) {
            ...
            if ("Показать шутку ✅".equals(messageText) || "/jokes".equals(messageText)) {
